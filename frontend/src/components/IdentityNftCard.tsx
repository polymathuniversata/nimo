    ...
    <Card className="relative overflow-hidden bg-gradient-nft shadow-nft animate-pulse-glow">
      ...
      <CardContent className="p-6 relative z-10">
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-4">
          <div className="w-16 h-16 rounded-lg overflow-hidden border-2 border-nft-glow/50 flex-shrink-0">
            <LazyImage
              src={identityNft}
              alt="Identity NFT"
          ...
          <div className="flex-1 text-center sm:text-left">
            <h3 className="text-lg sm:text-xl font-bold text-foreground">{userName}</h3>
...
export default IdentityNftCard;