...
>(({ className, sideOffset = 4, variant = 'default', ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      ...
      {
        'bg-popover text-popover-foreground border-border': variant === 'default',
        'bg-foreground text-background border-foreground/20': variant === 'dark',
        'bg-background text-foreground border-border shadow-xl': variant === 'light',
      },
      className
    )}
    {...props}
