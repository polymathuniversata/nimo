...
```j      "suggestion": "Provide a valid Cardano address (bech32 format)",on
{
  "error": {
    "code": "ERROR_CODE",
...
```json
{
  "error": {
    ...
    "details": {
      ...
      "rpc_url": "https://cardano-preview.blockfrost.io/api/v0",
...
```json
{
  "error": {
    ...
    "details": {
      ...
      "constraint": "Must be valid Cardano address",
...
```
- **HTTP Status**: 422
- **Cause**: Malformed Cardano address
