# Frontend Integration Guide - Nimo Platform (Vue.js/Quasar)
...
- Blockchain: Plutus Smart Contracts on Cardano
- AI: MeTTa reasoning for contribution verification
- Frontend: **Vue.js 3 + Quasar Framework** (actively implemented)
