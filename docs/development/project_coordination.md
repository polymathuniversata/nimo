...
forge script script/Deploy.s.sol:DeployScript --rpc-url cardano-preprod --broadcast --verify
...
# Blockchain Configuration (Cardano Network)
WEB3_PROVIDER_URL=https://cardano-preprod.blockfrost.io/api/v0
CARDANO_RPC_URL=https://cardano-mainnet.blockfrost.io/api/v0
NIMO_IDENTITY_CONTRACT_CARDANO_PREPROD=
NIMO_TOKEN_CONTRACT_CARDANO_PREPROD=
BLOCKCHAIN_SERVICE_PRIVATE_KEY=YOUR_PRIVATE_KEY_HERE
...
# Blockchain Configuration (Cardano Network)
VITE_CHAIN_ID=0
VITE_CARDANO_PREPROD_RPC_URL=https://cardano-preprod.blockfrost.io/api/v0
VITE_CARDANO_MAINNET_RPC_URL=https://cardano-mainnet.blockfrost.io/api/v0
VITE_IDENTITY_CONTRACT_CARDANO_PREPROD=
VITE_TOKEN_CONTRACT_CARDANO_PREPROD=
