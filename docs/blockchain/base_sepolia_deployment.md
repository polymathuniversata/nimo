# Cardano Preprod Deployment Guide

## Overview

This guide covers the complete deployment process for Nimo Platform smart contracts on Cardano Preprod testnet. Cardano Preprod is the official testnet for Cardano, providing a safe environment for testing before mainnet deployment.

**Network:** Cardano Preprod
**Chain ID:** 0
**RPC URL:** https://cardano-preprod.blockfrost.io/api/v0
...
- **Preferred Wallet:** Cardano wallet (Daedalus, Yoroi, Nami, etc.)

**User Authentication:**
- All users **MUST** sign in with a wallet
- Cardano wallets are **preferred** for optimal experience
...
**REQUIRED:** Users must sign in with a wallet (preferably Cardano)
